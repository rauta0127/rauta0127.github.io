...
Senior Data Scientist working in the financial industry, with a strong focus on machine learning, applied AI, and building practical data-driven systems.  
I am particularly interested in translating complex real-world problems into reliable ML solutions, from modeling and evaluation to deployment and operations.
...
- **[M5 Forecasting – Accuracy](https://www.kaggle.com/competitions/m5-forecasting-accuracy)**  
  - Silver Medal — 164 / 5,558 teams
- **[SIIM-ISIC Melanoma Classification](https://www.kaggle.com/competitions/siim-isic-melanoma-classification)**  
  - Bronze Medal — 268 / 3,308 teams
- **[Elo Merchant Category Recommendation](https://www.kaggle.com/competitions/elo-merchant-category-recommendation)**  
...
- **[#7 CA x atmaCup 2nd](https://www.guruguru.science/competitions/12/)**
  - 13th / 166 teams  
- **[#11 atmaCup](https://www.guruguru.science/competitions/17/)**
  - 15th / 614 teams
...
- **MLOps / Tools**: Git, Docker, Airflow, cloud-based ML workflows  
...
- Knowledge sharing through writing and competitions

---

*Disclaimer: This resume is a personal summary and does not represent any employer or organization.*
